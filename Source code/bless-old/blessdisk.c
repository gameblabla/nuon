      ...
      if (out) {
        ...
        if (!result) {
          ...
          if (coff) {
            ...
            *((unsigned long *)(bless_template + HASH_LIST_OFFSET)) = SWAP_LONG(APP_BLESS_TEMPLATE_LENGTH);
            *((unsigned long *)(bless_template + HASH_LIST_LENGTH_OFFSET)) = SWAP_LONG((numHashes * 16));
            *((unsigned long *)(bless_template + COFF_START_OFFSET)) =
              SWAP_LONG(APP_BLESS_TEMPLATE_LENGTH + (numHashes * 16) + APP_SIG_TEMPLATE_LENGTH);
            if (datSectors > 0) {
